...
公众号的选题、研究资料、文章版本与 HTML 排版归档。

当前定位正在调整，旧有“AI 治理 + 投资”仅作历史参考，不自动作为新文章的限制。
...
每篇文章按目录保存框架、资料、Markdown、HTML、配图与版本记录。HTML 是面向作者审阅和复制到 135 的主要交付格式。

本仓库本次只初始化工作流与本专题策划；历史稿件仍保留在桌面原目录，尚未迁移。
