...
- [需求与范围](brief.md)
- [此前写作逻辑与大纲 v3](outline-v3.md)
- [历史大纲 v2](outline-v2.md)
- [车企方案与采用边界](research/automotive-context-v3.md)
...
研究截止2026-09-14。共保存38条来源及线索，其中4条仅取得搜索摘要或入口，未用于正式定量结论或访谈转述。报告区分客户公告、技术文档、模型卡、访谈、综述和未完成补证的线索。未声称自行测试产品、审计客户收益或观看无法获取的会议视频。

当前修订稿：`article-v4.html`；纯文字：`article-v4.md`；图片包：`report-v4-images.zip`；离线完整包：`article-v4-package.zip`。新增素材及浏览器检查在`assets/report-v4/`。v3保留为历史。
