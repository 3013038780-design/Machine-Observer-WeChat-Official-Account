...
![个人电脑、专业创作与服务器环境｜AI 概念插画](../assets/v13/images/02-computing-lab.png)
...
![GeForce RTX 5090](../assets/v13/images/03-geforce.png)
...
![AI 在哪里运行？](../assets/v13/images/04-online-local.png)
...
![RTX PRO 6000 Blackwell](../assets/v13/images/06-rtx-pro.png)
...
![企业使用模型的三种方式](../assets/v13/images/07-enterprise-options.png)
...
![这些软件处在不同层级](../assets/v13/images/08-software-layers.png)
...
![DGX Spark](../assets/v13/images/09-dgx-spark.png)
...
![三种传输，连接不同对象](../assets/v13/images/10-connections.png)
...
![GB200 NVL72](../assets/v13/images/11-gb200.png)
...
![看报价，先看交付范围](../assets/v13/images/12-quote-scope.png)
...
![视觉识别、设备计算与仿真环境｜AI 概念插画，非实物接线图](../assets/v13/images/13-robot-lab.png)
...
![Jetson Orin 家族](../assets/v13/images/14-jetson.png)
...
![DRIVE 车载计算平台](../assets/v13/images/15-drive.png)
...
![七块产品，一张版图](../assets/v13/images/16-product-map.png)
